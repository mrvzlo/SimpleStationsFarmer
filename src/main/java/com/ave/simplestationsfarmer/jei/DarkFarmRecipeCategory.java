...
public class DarkFarmRecipeCategory implements IRecipeCategory<SimpleRecipe> {
        private static final String Path = "dark_farm";
        ...
        private final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
                        ...
                        "textures/gui/dark_farm_jei.png");
        ...
        public DarkFarmRecipeCategory(IGuiHelper guiHelper) {
        ...
        public Component getTitle() {
                return Component.translatable("screen.simplestationsfarmer.dark_farm_recipes");
        }
