...
public class FarmStationMenu extends BaseFarmMenu {
    public FarmStationMenu(int containerId, Inventory inventory, FriendlyByteBuf data) {
        super(containerId, inventory, data, Registrations.FARM_MENU.get());
    }

    public FarmStationMenu(int containerId, Inventory inventory, StationContainer be) {
        super(containerId, inventory, be, Registrations.FARM_MENU.get());
    }
