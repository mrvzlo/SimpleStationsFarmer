...
public class TreeFarmRecipeCategory implements IRecipeCategory<SimpleRecipe> {
        ...
        public Component getTitle() {
                return Component.translatable("screen.simplestationsfarmer.tree_farm_recipes");
        }

        @Override
        public @Nullable IDrawable getIcon() {
                return guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                                new ItemStack(ModBlocks.TREE_FARMER_BLOCK_ITEM.get()));
        }
        ...
        public List<Component> getTooltipStrings(SimpleRecipe recipe, IRecipeSlotsView recipeSlotsView, double mouseX,
                ...
                if (UIBlocks.WATER_BAR.isHovered(mouseX, mouseY))
                        list.add(Component.literal(TreeFarmerBlockEntity.WaterUsage + " mB"));
